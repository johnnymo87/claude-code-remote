...
echo "   - NGROK_DOMAIN (your ngrok domain, without https://)"
echo "   - TELEGRAM_WEBHOOK_SECRET (generate with: openssl rand -hex 32)"
echo "   - TELEGRAM_WEBHOOK_PATH_SECRET (optional, generate with: openssl rand -hex 16)"
echo ""
echo "   ⚠️  SECURITY: The webhook secret (header) is required - it prevents"
echo "   forged requests. The path secret is optional defense-in-depth."
echo ""
echo "2. Start ngrok in a terminal:"
echo "   ngrok http 4731 --url=\$NGROK_DOMAIN"
echo "   (Set NGROK_DOMAIN in .env to your reserved domain)"
echo ""
